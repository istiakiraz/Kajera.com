    ...
    <div>
      <div className="card bg-[#d6edeb]/50 lg:w-96 border transition-all duration-300 hover:scale-95 border-[#2b492e]/10 shadow-sm">
        ...
        <div className="flex flex-col w-11/12 mx-auto py-5 space-y-3 ">
          ...
          <h4 className="text-red-500 border flex gap-1 items-center hover:bg-red-200 hover:text-black/80 text-sm border-red-200 bg-white/70 p-1 w-fit px-3 rounded-2xl"> <MdOutlineAccessTimeFilled />Project Deadline : {task.dob}</h4>
